	...
	<nav class="navbar-default navbar-static-top"> 
		...
		<div class="collapse navbar-collapse" id="app-navbar-collapse"> 
			<ul class="nav navbar-nav"> 
				<li><a href="{{ url('/karyawan/create') }}">karyawan</a></li> 
			</ul> 
			<ul class="nav navbar-nav"> 
				<li><a href="{{ url('/produk/create') }}">produk</a></li> 
			</ul> <!-- Right Side Of Navbar --> 
			<ul class="nav navbar-nav navbar-right">
				<li><a href="{{ url('/otentikasi') }}">masuk</a></li> 
			</ul> 
		</div> 
	</div> 
</nav> 
...
bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-
0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS"
crossorigin="anonymous"></script>
{{-- <script src="{{ elixir('js/app.js') }}"></script> --}}
<script src="{{asset('js/tokokomputer.js')}}"></script>
</body>
</html>